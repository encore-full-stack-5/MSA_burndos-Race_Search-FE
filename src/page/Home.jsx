...
function Home() {
    return (
      <div className="h-full flex flex-col justify-center items-center">
            <div className="text-8xl font-bold tracking-widest pb-7" style={{color:"#03c75a"}}>
                NAVER
            </div>
            <div className="flex flex-row items-center border hover:shadow-md" style={{borderColor:"#03c75a"}}>
                <input className="h-8 w-96 border-none focus:outline-none px-1"/>
                <div className="border-r h-3/5 pl-2" style={{borderColor:"#03c75a"}}/>
                <svg id="search-btn" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" className="cursor-pointer" style={{width:"32px", height:"20px", fill: "#03c75a"}}>
